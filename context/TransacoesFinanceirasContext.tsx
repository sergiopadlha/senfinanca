...
export const TransacoesFinanceirasProvider: FC<Props> = function TransacoesFinanceirasProvider({ children }) {
    ...
    return (
        <TransacoesFinanceirasContext.Provider value={{ categorias, transacoesFinanceiras, updateTransacaoFinanceira, addTransacaoFinanceira, deleteTransacaoFinanceira }}>
            {children}
